...
<div class="new-nav-content-mobile">
  <div class="nav-list-mobile">
    <a href="#" class="nav-track-mobile-btn">Tracks</a>
    <div class="nav-tracks-mobile">
        ...
        <li class="nav-track-mobile" onclick="redirectMarket()">
          ...
          <div class="nav-track-content-mobile" >
            <a
              href="./marketing.html" 
              style="display: block; color: #495057; text-decoration: none"
              ><h4 class="nav-content-head-mobile">Digital Marketing</h4></a
            >
  ...
  <div class="nav-log-mobile">
    <a href="https://event.webinarjam.com/register/28/8q8lvbnp" class="nav-log-mobile-btn">Log In / Sign Up</a>
  </div>
</div>
`;
  ...
  <div class="laptop-nav-container">
    ...
    <div class="nav-links-laptop">
      ...
      <div class="nav-log-link-laptop">
        <a href="https://event.webinarjam.com/register/28/8q8lvbnp" class="nav-log-laptop-btn">Log In / Sign Up</a>
      </div>
    </div>
  </div>
</nav>

<div class="nav-laptop-tracks">
      ...
      <li class="nav-track-laptop" onclick="redirectData()">
        ...
        <div class="nav-track-content-laptop" >
          <a 
            ...
            style="display: block; color: #495057; text-decoration: none"
          >
            <h4 class="nav-content-head-laptop">Data Analytics</h4>
          </a>
          <div></div>
          <div class="nav-rating-container-laptop">
            ...
            <h4 class="nav-content-rating-laptop">4.4 (3200+ ratings)</h4>
          </div>
        </div>
      </li>
      <li class="nav-track-laptop" onclick="redirectMarket()">
        ...
        <div class="nav-track-content-laptop" >
          <a
            ...
            style="display: block; color: #495057; text-decoration: none"
          >
            <h4 class="nav-content-head-laptop">Digital Marketing</h4>
          </a>
          <div></div>
          <div class="nav-rating-container-laptop">
            <div class="nav-content-stars-laptop">
            ...
            <h4 class="nav-content-rating-laptop">4.7 (120+ ratings)</h4>
          </div>
        </div>
      </li>
    </ul>
