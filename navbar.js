...
function myFunction(x) {
  if (x.matches) {
    newNavBar.innerHTML = `<nav class="mobile" id="navbar">
      ...
      <div class="new-nav-content-mobile">
        ...
        <a
          href="#"
          class="nav-track-mobile-btn"
          onClick="navbarMobileAbout()"
          >About Us</a
        >
        <div class="nav-tracks-mobile" id="about-div-mobile">
          <ul class="nav-tracks-list-mobile" style="margin:10px 0px">
              ...
              <div >
                <a
                  ...
                  style="
                    ...
                    text-decoration: none;
                  "
                  ><h5 class="nav-content-head-mobile" style="font-size: 1rem !important; font-weight:600">About Trainity</h5></a
                >
                </div>
                </li>
    ...
    newNavBar.innerHTML = `<nav class="laptop" id="navbar">
        <div class="laptop-nav-container">
          ...
          <div class="nav-links-laptop">
            ...
            <div class="nav-tracks-link-laptop" style="margin-left:10px">
              <a
                href="#"
                class="nav-track-laptop-btn"
                onClick="navbarAboutuslaptop()"
                >About Us</a
              >
              <div class="nav-laptop-tracks" id="about-div-laptop">
                <div class="nav-tracks-laptop">
                 
                  <ul class="nav-tracks-list-laptop">
                    <li  onclick="redirectData()">
    ...
    window.addEventListener("mouseup", function (event) {
      ...
      var trackDiv = document.getElementById("about-div-laptop");
      if (event.target != trackDiv && event.target.parentNode != trackDiv) {
        trackDiv.style.display = "none";
      }
    });
...
const navbarMobileAbout = () => {
  const navMobile = document.getElementById("about-div-mobile");
  if (navMobile.classList.contains("on")) {
    navMobile.style.display = "none";
    navMobile.classList.remove("on");
  } else {
...
const navbarLaptop = () => {
  const navLapto = document.getElementById("about-div-laptop");
  if (navLapto.classList.contains("on")) {
    navLapto.style.display = "none";
    navLapto.classList.remove("on");
  }
...
const navbarAboutuslaptop  = () => {
  const navLaptop = document.getElementById("about-div-laptop");
  if (navLaptop.classList.contains("on")) {
    navLaptop.style.display = "none";
    navLaptop.classList.remove("on");
  } else {
